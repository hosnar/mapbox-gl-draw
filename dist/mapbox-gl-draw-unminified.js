...
function createSupplementaryPoints(geojson, options, basePath) {
  ...
  var userProperties = Object.keys(geojson.properties).filter(function (k) { return k.includes("user_"); }
  );

  supplementaryPoints.forEach(function (p) {
    userProperties.forEach(function (k) {
